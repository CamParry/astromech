...
**Status:** Designed (2026-06-16); unimplemented. Ship **Node (Sharp) and Cloudflare (Images) drivers simultaneously** to lock the driver shape from day one. No code until explicitly approved.
