            ...
            (
                [
                    ...
                    },
                    {
                        ...
                        fields: {
                            description:
                                'News, updates, and behind-the-scenes product decisions.',
                        },
                        status: 'published',
                        publishedAt: PUBLISHED_AT,
                        createdAt: now,
                    ...
                    },
                    {
                        ...
                        fields: {
                            description:
                                'Step-by-step guides to get the most out of Astromech.',
                        },
                        status: 'published',
                        publishedAt: PUBLISHED_AT,
                        createdAt: now,
                            ...
                            content: [
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        {
                                            question:
                                                'Can I use Astromech without Cloudflare?',
                                        ...
                                        {
                                            question:
                                                'Does Astromech support custom field types?',
                    ...
                    },
                    {
                        ...
                        fields: {
                            body: doc(
                                ...
                                para(
                                    text(
                                        'In Astromech, the blocks field is defined in your config:'
                                    )
                                ),
                                codeBlock(
                                ...
                                para(
                                    ...
                                    text('_disabled', 'code'),
                                    text(
                                        ') so they never collide with your own field names:'
                                    )
                                ),
                                codeBlock(
                        ...
                        fields: {
                            body: doc(
                                ...
                                para(
                                    ...
                                    text('locale', 'code'),
                                    text(
                                        ' option and get back only entries for that locale. The '
                                    ),
                        ...
                        fields: {
                            body: doc(
                                ...
                                para(
                                    text('Call '),
                                    text(
                                        'Astromech.plugins.seo.meta({ entry, locale })',
                                        'code'
                                    ),
                                    text(
                                ...
                                para(
                                    ...
                                    text(
                                        " response. Add a single Astro route and you're done."
                                    )
                                )
                            ),
                            excerpt:
