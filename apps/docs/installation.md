...
- `astro@6`, `kysely@0.28`, `@astrojs/react@5`, `@astrojs/node@10` and
  `@libsql/client@0.17` pin the versions Astromech supports. Without the pins,
  npm takes the newest releases (Astro 7, Kysely 0.29, libsql client 0.18),
  which fall outside Astromech's peer ranges, and stops with an `ERESOLVE`
  error.
