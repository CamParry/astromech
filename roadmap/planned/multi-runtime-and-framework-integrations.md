...
The vocabulary is settled: `decisions/0057-one-application-instance-thin-framework-integrations.md`
and `TERMINOLOGY.md` name this glue an integration, not an adapter.
