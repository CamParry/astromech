...
export function Textarea({
    ...
    const textareaClass = clsx('am-textarea', (error !== undefined || hasError) && 'am-textarea-error', className);
    const textareaEl = <textarea id={id} className={textareaClass} {...ariaProps} {...props} />;
