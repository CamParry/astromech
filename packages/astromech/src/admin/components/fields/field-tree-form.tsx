/**
 * Reusable field-tree form body. Renders a `ResolvedEntryFields` tree (main
 * + optional sidebar) using the same `EntryFieldColumn` renderer the
 * entry-edit page uses. Callers own state (`values`/`onChange`) and `disabled`.
 */
