  ...
  forbidden: [
    ...
    },
    {
      ...
      to: {
        ...
        pathNot:
          '^src/entries/(utils/url|type-registry)\\.(ts|js)$|^src/settings/page-values\\.(ts|js)$|^src/transport/http/client/',
      },
    },
    {
