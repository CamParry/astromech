...
| `pnpm run test:run`              | vitest across `packages/schema-engine/tests/`, `packages/astromech/tests/` and `packages/plugins/assistant/tests/`. The assistant suite needs `build` first                                                                                                                                                                                                |
