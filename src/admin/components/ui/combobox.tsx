 ...
 * Used for relation fields and entity lookups.
 */
        ...
        <div className="am-field">
            ...
            >
                <BaseCombobox.InputGroup className="am-combobox__input-group">
                    <BaseCombobox.Input
                        id={id}
                        className={['am-input am-combobox__input', error ? 'am-input--error' : ''].filter(Boolean).join(' ')}
                        placeholder={placeholder}
                    />
                    <BaseCombobox.Clear className="am-combobox__clear" aria-label="Clear">
                        <X size={14} />
                    </BaseCombobox.Clear>
                    <BaseCombobox.Trigger className="am-combobox__trigger" aria-label="Open">
                        <ChevronDown size={14} />
                    </BaseCombobox.Trigger>
                </BaseCombobox.InputGroup>
                <BaseCombobox.Portal>
                    <BaseCombobox.Positioner className="am-dropdown__positioner" sideOffset={4}>
