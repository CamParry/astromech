...
export function RelationshipField({ name, value, field, required, onChange }: BaseFieldProps) {
                            ...
                            return (
                                <React.Fragment>
                                    {selected.map((v) => (
                                        ...
                                        >
                                            ...
                                            <Combobox.ChipRemove
                                                ...
                                                aria-label={t('fields.relationshipRemove')}
                                            >
                                                <XIcon size={16} />
                                            </Combobox.ChipRemove>
                                        </Combobox.Chip>
                                    ...
                                    <Combobox.Input
                                        id={id}
                                        placeholder={
                                            selected.length > 0 ? '' : t('fields.relationshipSelect')
                                        }
